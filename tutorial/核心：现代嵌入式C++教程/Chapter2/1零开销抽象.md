...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/gpio_example.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/state_machine.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/raii_example.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/constexpr_example.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/inline_vs_macro.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/loop_unroll.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter02/01_zero_overhead/strong_types.cpp"
```text
