...
```cpp
--8<-- "codes_and_assets/examples/chapter08/02_type_safe_register/reg.hpp"

```

```cpp
--8<-- "codes_and_assets/examples/chapter08/02_type_safe_register/uart_regs.hpp"

```

```cpp
--8<-- "codes_and_assets/examples/chapter08/02_type_safe_register/main.cpp"
