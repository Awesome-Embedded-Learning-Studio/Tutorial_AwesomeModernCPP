...
```cpp
--8<-- "codes_and_assets/examples/chapter08/07_literal_operators/time_units.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter08/07_literal_operators/frequency_units.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter08/07_literal_operators/voltage_units.cpp"
```text
