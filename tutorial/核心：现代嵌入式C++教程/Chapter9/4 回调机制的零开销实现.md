...
```cpp
--8<-- "codes_and_assets/examples/chapter09/04_zero_overhead_callbacks/zero_callback.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter09/04_zero_overhead_callbacks/event_system.cpp"
```text
