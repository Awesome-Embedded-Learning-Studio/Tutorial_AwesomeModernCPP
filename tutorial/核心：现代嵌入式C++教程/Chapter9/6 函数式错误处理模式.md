...
```cpp
--8<-- "codes_and_assets/examples/chapter09/06_functional_error_handling/basic_result.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter09/06_functional_error_handling/combinators.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter09/06_functional_error_handling/config_loader.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter09/06_functional_error_handling/peripheral_init.cpp"
```text
