...
```cpp
--8<-- "codes_and_assets/examples/chapter09/07_ranges_views_basics/view_basics.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter09/07_ranges_views_basics/filter_views.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter09/07_ranges_views_basics/sensor_pipeline.cpp"
```text
