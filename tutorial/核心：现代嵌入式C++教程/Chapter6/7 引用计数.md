...
```cpp
--8<-- "codes_and_assets/examples/chapter06/07_reference_counting/intrusive_refcount.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter06/07_reference_counting/atomic_refcount.cpp"
```text
