...
```cpp
--8<-- "codes_and_assets/examples/chapter06/03_shared_ptr_embedded_considerations/basic_usage.cpp"
...
```cpp
--8<-- "codes_and_assets/examples/chapter06/03_shared_ptr_embedded_considerations/circular_reference.cpp"
