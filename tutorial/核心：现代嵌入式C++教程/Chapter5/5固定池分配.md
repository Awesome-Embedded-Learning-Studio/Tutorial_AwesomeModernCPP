...
```cpp
--8<-- "codes_and_assets/examples/chapter05/05_fixed_pool_allocation/fixed_pool.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter05/05_fixed_pool_allocation/slab_allocator.cpp"
```text
