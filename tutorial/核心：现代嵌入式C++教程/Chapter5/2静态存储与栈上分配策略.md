...
```cpp
--8<-- "codes_and_assets/examples/chapter05/02_static_vs_stack_allocation/static_allocation_demo.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter05/02_static_vs_stack_allocation/stack_allocation_demo.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter05/02_static_vs_stack_allocation/ring_buffer_demo.cpp"
```text
