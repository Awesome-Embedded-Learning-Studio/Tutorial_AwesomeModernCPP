...
```cpp
--8<-- "codes_and_assets/examples/chapter05/03_object_pool_pattern/object_pool.cpp"

```

```cpp
--8<-- "codes_and_assets/examples/chapter05/03_object_pool_pattern/specialized_pool.cpp"
