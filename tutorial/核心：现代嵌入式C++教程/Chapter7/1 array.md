...
```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/basic_usage.cpp"
```text

</details>

<details>
<summary>查看更多示例：静态存储、DMA、编译期查表等</summary>

```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/static_storage.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/dma_usage.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/constexpr_table.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/constexpr_crc_table.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/structured_binding.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/01_array/c_api_compatible.cpp"
```text
