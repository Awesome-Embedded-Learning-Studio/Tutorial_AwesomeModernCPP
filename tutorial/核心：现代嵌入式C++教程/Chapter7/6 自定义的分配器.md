...
```c
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/bump_allocator.h"

```

```cpp
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/bump_allocator_demo.cpp"
...
```c
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/fixed_pool.h"

```

```cpp
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/fixed_pool_demo.cpp"

```

```c
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/stack_allocator.h"

```

```cpp
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/stack_allocator_demo.cpp"

```

```cpp
--8<-- "codes_and_assets/examples/chapter07/06_custom_allocator/placement_new_demo.cpp"
