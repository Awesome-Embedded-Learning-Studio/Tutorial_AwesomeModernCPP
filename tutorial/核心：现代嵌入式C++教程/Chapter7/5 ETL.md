...
```cpp
--8<-- "codes_and_assets/examples/chapter07/05_etl/etl_vector_demo.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter07/05_etl/etl_queue_demo.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/05_etl/etl_pool_demo.cpp"
```text
