...
```cpp
--8<-- "codes_and_assets/examples/chapter07/04_intrusive_container/intrusive_list.h"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/04_intrusive_container/inheritance_example.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter07/04_intrusive_container/member_hook.h"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/04_intrusive_container/member_hook_example.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/04_intrusive_container/task_scheduler_example.cpp"
```text
