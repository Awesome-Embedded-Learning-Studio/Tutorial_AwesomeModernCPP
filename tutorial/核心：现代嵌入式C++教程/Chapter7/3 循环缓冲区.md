...
```cpp
--8<-- "codes_and_assets/examples/chapter07/03_circular_buffer/ring_buffer.h"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/03_circular_buffer/basic_example.cpp"
```text
...
```cpp
--8<-- "codes_and_assets/examples/chapter07/03_circular_buffer/uart_example.cpp"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/03_circular_buffer/atomic_ring_buffer.h"
```text

```cpp
--8<-- "codes_and_assets/examples/chapter07/03_circular_buffer/thread_safe_example.cpp"
```text
