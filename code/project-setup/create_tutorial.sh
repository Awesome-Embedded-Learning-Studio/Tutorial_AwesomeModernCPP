...
TUTORIALS_BASE="${REPO_ROOT}/code/stm32f1-tutorials"
...
msg_success "Done! Tutorial created at: code/stm32f1-tutorials/${DIR_NAME}"
printf "\n  ${CYAN}cd code/stm32f1-tutorials/%s && mkdir build && cd build && cmake ..${NC}\n" "${DIR_NAME}"
