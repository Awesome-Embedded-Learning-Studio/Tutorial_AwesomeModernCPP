...
In-depth coverage of C++11/14/17 core features. The key volume that distinguishes "modern C++" from "legacy C++."
...
Deep dives into STL containers, iterators, algorithms, and source code analysis.
...
C++20/23/26 advanced features: Concepts, Ranges, Coroutines, Modules, Template Metaprogramming.

- [Start Reading](vol4-advanced/index.md)

---

### Volume 5: Concurrency

From thread primitives to coroutine-based async — master C++ concurrent programming.
...
Practical applications of modern C++ across domains: embedded development, networking, GUI/graphics, data storage, algorithms and data structures.
...
- [Compilation & Linking — Part 1](compilation/01-compilation-and-linking-overview.md)

---

### End-to-End Projects

Hand-written STL components, a mini HTTP server, a GUI framework, an embedded OS, and other comprehensive projects.
