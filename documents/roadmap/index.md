...
- **定位**：在线做题栏目——一周一包题，在浏览器里写、在浏览器里判，把读到的知识变成手感。
- **关键主题**：题型混搭——实现题（函数式 / 程序式，在线编译逐用例判题）、猜输出、概念选择、找 bug、思考题；判题环境 gcc / C++23。
- **难度 · 前置**：按题标注 ★☆☆–★★★ / 卷一起步即可做，难度随卷推进。
- **建议节奏**：穿插在主线里当「课后练习」——每学完一块，来一包题保持手感；进度记在本地浏览器，不赶进度。
...
- **用做题保持手感**：[每周一些题](/weekly-problems/)一周一包、在线判题，读完卷一即可上手，穿插在主线里当课后练习。
...
- [每周一些题](/weekly-problems/)：在线做题栏目，一周一包题、浏览器里直接写直接判，欢迎投稿出题。
